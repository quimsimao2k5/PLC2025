from sExpp_anasin import parser
import sys
import webbrowser
import pyperclip
...
try:
    ...
    if texto_completo.strip():
        ...
        if not parser.error and result:
            ...
            print("\n[Info] Código copiado para a área de transferência!")
            print("[Info] A abrir o site da VM...")
            webbrowser.open("https://ewvm.epl.di.uminho.pt/run")
